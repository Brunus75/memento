...
* [LES SERVICES ET LES DEPENDANCES](#services-dependances)
* [LES FORMULAIRES](#les-formulaires)
* [LA PROGRAMMATION REACTIVE](#la-programmation-reactive)
* [EFFECTUER DES REQUETES HTTP](#requetes-http)
* [L'AUTHENTIFICATION](#auth)
* [MODIFIER DYNAMIQUEMENT LE TITRE DES PAGES](#modif-titre)
...
```
* déclarer les const en camelCase
```js
const mockPokemons = ['Salamèche', 'Bulbizzare'];
```
...
## <a name="services-dependances"></a> LES SERVICES ET LES DEPENDANCES
```js
...
## <a name="requetes-http"></a> EFFECTUER DES REQUETES HTTP 

* API = interface de programmation, permet de communiquer avec un service distant depuis votre appli
```js
...
### <a name="auth"></a> L'AUTHENTIFICATION
```js
○ Un Guard
...
## <a name="modif-titre"></a> MODIFIER DYNAMIQUEMENT LE TITRE DES PAGES
